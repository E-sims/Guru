...
const AdviceCard = () => {
  ...
  if (isLoading) {
    return (
      <div className="w-[343px] h-auto md:w-[540px] rounded-xl p-6 md:p-12 bg-drkGray flex flex-col items-center justify-center relative shadow-darkBlue shadow-sm">
        ...
        <div className="absolute transition-all -bottom-8 rounded-full bg-neon flex items-center justify-center w-16 h-16 cursor-pointer hover:blur-lg">
  ...
  return (
    <div className="w-[343px] h-auto md:w-[540px] rounded-xl p-6 md:p-12 bg-drkGray flex flex-col items-center justify-center relative shadow-darkBlue shadow-sm z-0">
      <p id="quote-id" className="text-neon mb-6 font-medium">
        {id}
      </p>
      <p className="text-cyan quote-text text-center font-extrabold max-w-[444px]">
      ...
      <div
        className="absolute -bottom-8 rounded-full bg-neon flex items-center justify-center w-16 h-16 cursor-pointer z-10 hover:button-shadow transition-shadow ease-in-out"
        onClick={getQuote}
      >
        <img src="/icon-dice.svg" alt="dice icon" />
      </div>
